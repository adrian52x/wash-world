...
export class UpdatedTables1748256681183 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "wash_types" ("wash_type_id" SERIAL NOT NULL, "type" "public"."wash_types_type_enum" NOT NULL, "description" character varying(1024) NOT NULL, "price" numeric(6,2) NOT NULL, "is_auto_wash" boolean NOT NULL, CONSTRAINT "PK_f023b0697a4dccc5292ddc48e4d" PRIMARY KEY ("wash_type_id"))`);
        await queryRunner.query(`CREATE TABLE "locations" ("location_id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "address" character varying(255) NOT NULL, "opening_hours" character varying(255) NOT NULL, "auto_wash_halls" integer, "self_wash_halls" integer, "coordinates" json NOT NULL, CONSTRAINT "PK_582bb9b1865f02814bd7c2c9650" PRIMARY KEY ("location_id"))`);
        await queryRunner.query(`CREATE TABLE "washes" ("wash_id" SERIAL NOT NULL, "user_id" integer NOT NULL, "date_time" TIMESTAMP NOT NULL, "amount_paid" integer NOT NULL, "wash_type_id" integer, "location_id" integer, CONSTRAINT "PK_ab742d1b5d3707f82d16718d84e" PRIMARY KEY ("wash_id"))`);
        await queryRunner.query(`CREATE TABLE "memberships" ("membership_id" SERIAL NOT NULL, "type" "public"."memberships_type_enum" NOT NULL, "price" numeric(6,2) NOT NULL, "wash_type_id" integer, CONSTRAINT "PK_7a384cb49f51572dda94f5b281c" PRIMARY KEY ("membership_id"))`);
