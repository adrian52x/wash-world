...
export const ExtraFeaturesCard: React.FC<ExtraFeaturesCardProps> = ({
  loading,
  error,
  stats,
  onDowngrade,
      ...
      <>
        <View className="gap-2 mb-2">
            ...
            <View className="flex-row justify-between items-center border-b border-gray-200 pb-3">
                ...
                <Text className="font-semibold text-gray-900">{stats?.favoriteWashType?.type ?? '-'} ({stats?.favoriteWashType?.useCount ?? 0})</Text>
            </View>
            <View className="flex-row justify-between items-center border-b border-gray-200 pb-3">
                <Text className="text-gray-500">Favorite location:</Text>
                <Text className="font-semibold text-gray-900">{stats?.mostUsedLocation?.name ?? '-'} ({stats?.mostUsedLocation?.visitCount ?? 0})</Text>
            </View>
            <View className="flex-row justify-between items-center border-b border-gray-200 pb-3">
