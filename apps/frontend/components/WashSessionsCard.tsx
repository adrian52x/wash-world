    ...
    {loading ? (
      ...
      <>
        {(sessions ?? []).slice(0, 3).map((wash) => (
          <View key={wash.washId} className="mb-3 pb-3 border-b border-gray-100 flex-row items-center">
        ...
        {sessions.length > 3 && (
          <TouchableOpacity className="mt-2 py-2 rounded bg-green-light active:bg-green-200" onPress={onSeeAll}>
